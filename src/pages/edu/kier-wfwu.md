---
title: "Lessons from Kier Cuadras of Wells Fargo Workers United"
description: "Practical organizing lessons from a successful small-unit bank campaign."
layout: ~/layouts/Markdown.astro
---

# Lessons from Kier Cuadras of Wells Fargo Workers United

The usual kind of union, what everyone thinks of typically, involves a group of *similarly situated* workers joining together to win a *union election* and force the company to bargain collectively. The win comes with many extra legal protections for workers, and it's the kind we ultimately aspire to.
...
* Help coworkers reassure *each other* rather than being a single source of hope.
...
* Use natural workplace conversations, such as breaks, lunch, and text conversations, to test the waters and build confidence.
* Encourage member initiative and lead from where you are: *We don't need experts; we need the motivated and willing.*
* It's all about connecting with coworkers.
...
* Many teams have good work-related reason to have a way to reach colleagues outside of work, for example, a group chat for "there's a production issue; can someone from North America please log in?"
* The right size of union varies. Often, your boss's boss commands a suitable department.
* All communications on company-owned systems are monitored for unusual statistics and probably also keyword alarms. Therefore, make sure there is *plausible cover* for anything you might do or say on MS Teams, email, Zoom, and similar tools in support of organizing. You can arrange to meet, for example, for lunch or coffee, but don't mention the U-word or specific grievances where [WADU](https://www.linkedin.com/pulse/j-p-morgans-wadu-employee-data-surveillance-system-medha-rashmi-h7uac/) can log it.
